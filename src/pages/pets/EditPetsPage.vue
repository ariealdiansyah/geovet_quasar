...
const data = ref();
// ubah ini menjadi masing masing data reactive dari state sesuai dengan variabel yang dimiliki pets
// const name = computed({
//   get() {
//     return store.state.groceries.data.name;
//   },
//   set(value) {
//     store.commit("groceries/setData", { name: value });
//   },
// });

onMounted(async () => {
  console.log("route", route.params.id);
  // const res = await store.dispatch("pets/detail", route.params.id);
  // if (res) {
  // data.value = res;
  // }
});
